  ...
  return (
    <div className="rounded-2xl border border-[#e2e8d5] bg-[#f0f6e6] p-8 shadow-sm">
      <h2 className="mb-6 flex items-center gap-2 text-lg font-bold text-gray-900">
        <svg className="w-5 h-5 text-[#82c600]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="mt-8 flex justify-end">
        <button className="rounded-xl bg-[#4d7013] px-8 py-3.5 text-[11px] font-black uppercase tracking-widest text-white shadow-sm transition-colors hover:bg-[#3d5a0f]">
          Save Changes
        </button>
      </div>
    </div>
