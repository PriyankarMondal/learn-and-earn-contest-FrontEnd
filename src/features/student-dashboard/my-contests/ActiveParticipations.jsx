...
const activeContestsData = [
  {
    ...
    desc: 'Implement a complex store architecture using Redux Toolkit and middleware for high-performance data fetching.',
  ...
  },
  {
    ...
    desc: 'Mobile Application for Digital Education Systems.',
    ...
    <div className="mb-12 mt-10">
      <div className="mb-6 flex items-center justify-between">
        ...
        {activeContestsData.slice(0, 1).map((contest) => (
          <div key={contest.id} className="flex flex-col md:flex-row flex-1 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6 gap-6 shadow-sm overflow-hidden transition-all hover:shadow-md">
        ...
        {activeContestsData.slice(1, 2).map((contest) => (
          <div key={contest.id} className="w-full lg:w-[320px] shrink-0 rounded-2xl bg-[#f7f9f2] p-6 shadow-sm border border-[#e8eed8] flex flex-col text-left transition-all hover:shadow-md">
